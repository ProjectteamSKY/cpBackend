...
#     id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
#     name = Column(String(50), unique=True, nullable=False)  # e.g., "square", "rounded", "oval"
#     description = Column(Text)
#     created_at = Column(DateTime, default=datetime.utcnow)
#     updated_at = Column(DateTime, default=datetime.utcnow)

#     products = relationship("Product", back_populates="product_type_rel")
...
#     product_type_id = Column(UUID(as_uuid=True), ForeignKey("product_types.id", ondelete="SET NULL"))  # FK link
...
#     product_type_rel = relationship("ProductType", back_populates="products")  # FK relationship
